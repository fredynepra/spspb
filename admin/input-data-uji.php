	...
	<nav class="navbar navbar-inverse">
	  <div class="container-fluid">
        ...
        <ul class="nav navbar-nav" >
			...
			<li class="active"><a href="input-data-uji.php">Data Testing</a></li>
		...
		<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <form class="form-horizontal col-sm-offset-2" method="post" action="tambahDataTesting.php">
          	...
          	<tbody>
            	<tr>
					...
					<td align="center" width="140">
						<a href="form-edit-data-testing.php?id=<?php echo $data[0] ?>" class="btn btn-success btn-sm">
							<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit
						</a>
						<a href="deleteDataTesting.php?id=<?php echo $data[0] ?>" class="btn btn-danger btn-sm">
